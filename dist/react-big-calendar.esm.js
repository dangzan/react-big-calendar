...
function CalOverlay(_ref) {
  ...
  if (!(overlay !== null && overlay !== void 0 && overlay.position)) return null
...
var BackgroundCells = function BackgroundCells(props) {
    ...
    var selectorClicksHandler = function selectorClicksHandler(
      ...
      if (!isEvent(node, point) && !isShowMore(node, point)) {
        ...
        if (pointInBox(rowBox, point)) {
          var currentCell = getSlotAtX(rowBox, point.x, rtl, _range.length)
          _selectSlot({
  ...
  return /*#__PURE__*/ React.createElement(
    'div',
    {
      className: clsx(props.className, 'rbc-row-bg'),
      ref: containerRef,
    },
...
var EventRow = function EventRow(props) {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    segments.reduce(function (row, _ref, li) {
      ...
      var content = EventRowMixin.renderEvent(props, event)
      if (gap)
...
var DateContentRow = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  var accessors = props.accessors,
    className = props.className,
    components = props.components,
  ...
  var headingRowRef = useRef()
  var eventRowRef = useRef()
  var slotMetrics = getSlotMetrics$1()
  useImperativeHandle(
    ref,
    function () {
      return {
  ...
  var handleShowMore = function handleShowMore(slot, target) {
    ...
    var row = qsa(containerRef.current, '.rbc-row-bg')[0]
    var cell
  ...
  function getRowLimit() {
    ...
    var eventHeight = getHeight(eventRowRef.current)
    var headingHeight =
      headingRowRef !== null &&
      ...
      headingRowRef.current
        ...
        : 0
    var eventSpace = getHeight(containerRef.current) - headingHeight
...
var MonthView = function MonthView(props) {
  ...
  var containerRef = useRef(null)
  var slotRowRef = useRef(null)
  // using this to replace getDerivedPropsFromState
  var prevDatePropRef = useRef()
  var _pendingSelection = useRef([])
  var _selectTimer = useRef(null)
  ...
  function renderDateHeading(_ref) {
    ...
    var DateHeaderComponent = components.dateHeader || DateHeader
    return /*#__PURE__*/ React.createElement(
      'div',
      Object.assign({}, props, {
        className: clsx(
  ...
  function handleShowMore(events, date, cell, slot, target) {
    ...
    clearSelection()
    if (popup) {
      var position = getPosition$1(cell, containerRef.current)
      setOverlay({
        date: date,
        events: events,
        position: position,
...
function TimeSlotGroup(props) {
  var renderSlot = props.renderSlot,
    ...
    Wrapper =
      _props$components2$ti === void 0 ? NoopWrapper : _props$components2$ti
...
var _excluded$4 = ['eventContainerWrapper'],
  _excluded2$1 = ['dayProp']
...
var DayColumn = function DayColumn(_ref) {
  ...
  var accessors = props.accessors,
    ...
    components = _objectWithoutProperties(_props$components, _excluded$4),
    date = props.date,
    dayLayoutAlgorithm = props.dayLayoutAlgorithm,
    getNow = props.getNow,
    _props$getters = props.getters,
    dayProp = _props$getters.dayProp,
    getters = _objectWithoutProperties(_props$getters, _excluded2$1),
    isNow = props.isNow,
    localizer = props.localizer,
    longPressThreshold = props.longPressThreshold,
    max = props.max,
  ...
  var prevTimeIndicatorPositionRef = useRef(null)
  var containerRef = useRef(null)
  var slotMetrics = getSlotMetrics(props)
...
var TimeGridHeader = function TimeGridHeader(props) {
  ...
  function renderHeaderCells(range) {
    var localizer = props.localizer,
      ...
      HeaderComponent =
        _props$components$hea === void 0 ? Header : _props$components$hea
    var today = getNow()
  ...
  var width = props.width,
    ...
    ResourceHeaderComponent =
      _props$components$res === void 0 ? ResourceHeader : _props$components$res,
    resizable = props.resizable
  var style = {}
  if (isOverflowing) {
...
var TimeGrid = function TimeGrid(props) {
  ...
  var updatingOverflowRef = useRef(false)
  var scrollRef = useRef()
  var contentRef = useRef()
  var containerRef = useRef()
  var scrollRatio = useRef()
  var gutterRef = useRef()
  var pendingSelection = useRef()
  ...
  var memoizedResources = memoize(function (resources, accessors) {
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        'button',
        {
          type: 'button',
          onClick: function onClick() {
            return handleNavigate(navigate.TODAY)
          },
        },
        messages.today
      ),
      /*#__PURE__*/ React.createElement(
        'button',
        {
          type: 'button',
          onClick: function onClick() {
            return handleNavigate(navigate.PREVIOUS)
          },
        },
        messages.previous
      ),
      /*#__PURE__*/ React.createElement(
        'button',
        {
          type: 'button',
          onClick: function onClick() {
            return handleNavigate(navigate.NEXT)
          },
        },
        messages.next
      )
